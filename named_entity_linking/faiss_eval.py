...
def main():
    ...
    # Load query (evaluation samples) and KB (ground truth) entities
    ...
    if build_index:
        ...
        # Map eval samples to ground truth entities to ensure accurate performance assessment
    ...
    # Get performance scores for top-k values
